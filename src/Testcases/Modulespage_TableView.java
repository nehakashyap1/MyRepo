...
public class Modulespage_TableView {
	...
	public void configure(){
		...
		System.out.println("Test cases execution on Modules page from table view ");
		System.out.println("--------------------------------------");
		
	}
	
	 @Test(priority=1)
	    public void Open_Modulespage_TableView()
	    {
	 ...
	 @Test (priority=3)
	    public void check_selectAllbtn(){
	       ...
	       @Test(priority=5)
	  	    public void Open_RadialView_FromModulespage(){
