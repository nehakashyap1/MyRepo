...
public class Radial {
   ...
   @FindBy (xpath="//div/input[@id='studentsButton' and @value='Apply']") 
    ...
    @FindBy (xpath="//div/input[@id='allsubgroups' and @value='Select All']")
     ...
     @FindBy (xpath="//div[@id='content']//a[@href='group?view=circle&classId=7696']")
     
     private WebElement RadialView_lnk;
     
     public WebElement GetRadialView_lnk(){
    	 
    	 return RadialView_lnk;
     }
     
    @FindBy (xpath="//div/ul/li/input[@id='195447']")
